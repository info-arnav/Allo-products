        ...
        <main className={styles.main}>
          <section className={styles.hero}>
            <div className={styles.heroContent}>
              ...
              <p className={styles.heroSubtitle}>
                Download the Allo app and get groceries, fresh food, and
                essentials from your local stores delivered in minutes.
                Supporting small-scale retailers in Vasant Vihar while giving
              ...
              <div className={styles.heroCta}>
                <div className={styles.appButtons}>
                  ...
                  >
                    ...
                    <div>
                      <div className={styles.appButtonLabel}>
                        Download on the
                      </div>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionSubtitle}>
              Order anything in three simple steps
            </p>
            <div className={styles.steps}>
              <div className={styles.step}>
                ...
                <p>
                  Download Allo and explore products from your local stores —
                  all in one place
                </p>
              </div>
              <div className={styles.step}>
                ...
                <p>
                  Select what you need, choose your store, and checkout with
                  secure payment
                </p>
              </div>
              <div className={styles.step}>
                ...
                <p>
                  Your order arrives from local stores in Vasant Vihar, usually
                  within 30 minutes
                </p>
              </div>
            </div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.features}>
              <div className={styles.feature}>
                ...
                <p>
                  Not 10 minutes with a stressed rider. Real deliveries in 30
                  minutes from stores walking distance away.
                </p>
              </div>
              <div className={styles.feature}>
                <div className={styles.featureIcon}>
                ...
                <p>
                  The kirana that knows your family. The medical store that
                  keeps your history. Real relationships, not algorithms.
                </p>
              </div>
              <div className={styles.feature}>
                <div className={styles.featureIcon}>
                ...
                <h3>Simple & Fast</h3>
                <p>
                  Browse products, place orders, and track delivery — all in one
                  easy-to-use app designed for speed.
                </p>
              </div>
              <div className={styles.feature}>
                <div className={styles.featureIcon}>
                ...
                <p>
                  Fresh vegetables from morning markets. Not warehouse stock
                  from last week.
                </p>
              </div>
            </div>
          ...
          <section className={`${styles.section} ${styles.visionSection}`}>
            <div className={styles.visionContent}>
              <h2 className={styles.sectionTitle}>
                Supporting Local, Expanding Selection
              </h2>
              <p className={styles.visionText}>
                Today, we're delivering groceries and essentials from
                small-scale retailers in Vasant Vihar. Tomorrow, we're bringing
                more neighborhoods and more categories online.
              </p>
              ...
              <p className={styles.visionTagline}>
                <strong>
                  Every local store, digitally accessible. Everything you need,
                  from shops you trust.
                </strong>
              </p>
              <p className={styles.visionDescription}>
                We're building the infrastructure that makes every store in your
                neighborhood reachable. Fast delivery, wide selection, zero
                hassle — powered by the businesses that already exist around
                you.
              </p>
            </div>
          </section>
          ...
          <section className={styles.ctaSection}>
            ...
            <p>
              Join your neighbors in Vasant Vihar who are already shopping local
            </p>
            <div className={styles.appButtons}>
              <a
                href="https://play.google.com/store/apps/details?id=com.allo.app"
